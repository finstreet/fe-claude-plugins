---
name: routes
description: Resolves, adds, and edits routes in the project. Use when you need to determine route paths, add routes to routes.ts, or look up existing routes.
user-invocable: false
context: fork
model: sonnet
allowed-tools: Read, Write, mcp__plugin_automation_context-forge-mcp__update_subtask_content, mcp__plugin_automation_context-forge-mcp__update_task_context
---
